...
func NewJSONEncoder(config *Config, cfg zapcore.EncoderConfig) zapcore.Encoder {
	return newJSONEncoder(config, cfg, false)
}

func newJSONEncoder(config *Config, cfg zapcore.EncoderConfig, spaced bool) *jsonEncoder {
